...
public class Intro_App extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!prefManager.isFirstTimeLaunch() && prefManager.isReopenAppIntro()) {
        ...
        prefManager.setReopenAppIntro(true);
...
/* TODO: uncomment these lines if you wanna start with introduction slides
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(Intro_App.this, MainActivity.class));
        freeMemory();
        finish();
    }
